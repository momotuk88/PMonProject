...
'statsinf' => 'Пареметри комутатора CPU,Temp',
...
'oid_opis' => 'Опис запита',
'oid_opis_descr' => 'Опис запита що отримуємо',
'oid_filter' => 'Тип фільтрування',
'oid_filter_descr' =>'Автоматичний режин в більшості випадків',
