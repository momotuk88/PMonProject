...
$nova_ukraine = array(
'pmon' => 'PMon - система моніторингу і керування комутаторами ZTE, BDCOM, HUAWEI, CDATA, GCOM',
'tmc' => 'ТМЦ',
'portmon' => 'Моніторинг портів',
'porterr' => 'Помилки на портах',
'statsinf' => 'Параметри комутатора CPU,Temp',
'statsping' => 'Статистика пінгування SNMP',
'cfg_bad_rx_log' => 'Величина/Різниця сигналу RX',
'cfg_bad_rx_log_descr' => 'Зміна рівня сигналу RX (величини) при якому логується сигнал',
'rxlog1' => 'Постійно пишу',
'rxlog2' => 'Постійно писати',
'rxlog3' => 'Тільки при зміні',
'newonuday' => 'Нових onu',
'cfglogsignal' => 'Моніторити сигнал RX',
'cfglogsignaldescr' => 'Збереження, логування сигналів ONU',
'mdel' => 'Видалити моніторинг',
'madd' => 'Додати в моніторинг',
'm' => 'Моніториться',
'monitor_onu' => 'Моніторинг ONU',
'bad_signal' => 'Погані сигнали',
'day_m' => 'За місяць',
'day_week' => 'За тиждень',
'day_later' => 'За вчора',
'clears' => 'Очистити статистику',
'day_curent' => 'За сьогодні',
'empty_snmp_ping' => 'Пристрій перестав відповідати на SNMP запити',
'load_cpu' => 'Процесор завантажений на ',
'empty_search' => 'Відсутні дані по вашому запиті',
'alloid' => 'Весь список',
'opis' => 'Опис',
'cfgonuinf' => 'Профіль конфігурації ONU',
'oid_opis' => 'Опис запиту',
'oid_opis_descr' => 'Опис запиту, що отримуємо',
'oid_filter' => 'Тип фільтрування',
'oid_filter_descr' =>'Автоматичний режим в більшості випадків',
'oid_task' => 'Задача OID-у',
'oid_task_descr' => 'rx- сигнал, dist - довжина волокна',
'oid_techs' => 'OID',
'oid_techs_descr' => '.keyonu - ід ону, .keyport - ід порта',
'oid_tech' => 'Технологія',
'oid_tech_descr' => 'onu - ону<br> health - параметри<br> global - глобальні<br> monitor - мніторинг',
'oid_types' => 'Тип',
'oid_types_descr' => 'epon, gpon - технологія<br> device - пристрій<br> port - порт',
'oid_type' => 'Тип комутатора',
'oid_type_descr' => ' Категорія OID',
'cfg_view_ip' => 'Показувати IP-адресу',
'vid' => 'Від',
'cfg' => 'Налаштування',
'do' => 'До',
'monitorport' => 'Моніторинг портів',
'deletonunomark' => 'Видалення невідомої ONU ',
'deletonu' => 'Видалення ONU ',
...
'port' => 'Порти',
'typeport' => 'Тип порта',
'coutporterr' => 'К-ть помилок на оптичному порті',
'status' => 'Статус',
'countmac' => 'MAC`ів за ONU',
'registers' => 'Зареєсстрована',
...
'cfg_statusport_descr' => 'Показувати список статусу портів коли вимикався',
...
'intervalmonitor' => 'Інтервал моніторингу',
'intervalmonitordescr' => 'З якою періодичність перевіряється пристрій',
'hor' => 'год',
'min' => 'хв',
'15min' => '15 хвилин',
'30min' => '30 хвилин',
...
'cfg_count_switch' => 'К-ть Комутаторів',
'cfg_count_descr' => 'К-ть терміналів відображено на одній сторінці',
'cfg_count_switch_descr' => 'К-ть Комутаторів відображено на одній сторінці',
...
'stekyvania_descr_dialog' => 'Стекування PON дерева з фізичним портом комутатора',
'geounit' => 'Зберегти координати розташування вузла', 
'unitnote' => 'Нотатки для вузла', 
'monitorapi' => 'URL API системи', 
...
'emptytempdataonu' => 'Невідома причина: системний SNMPWALK - працює, преверірте налаштування CRON',
'emptyarraydata' => 'Неможливо сформувати масив для опитування комутатора',
'emptysnmpwalk' => 'Неможливо отримати інформацію через SNMPWALK - преверірте правильність OID',
...
'curname' => 'Коротка назва комутатора',
...
'4h' => '4 години',
'sec' => 'секунд',
'setup' => 'Налаштування системи моніторингу',
...
'load_temp' => 'Температура коммутатора',
...
'edit_monitor_descr' => 'Моніторинг комутатора системою',
...
'metr' => 'метр',
'onlyonline' => 'Тільки активні',
'rxsignal' => 'Сигнал до ONU',
'models' => 'Виробник',
...
'logrx' => 'Графік Rx',
'connects' => 'Комутація',
'connectsports' => 'Комутація портів',
'log' => 'Журнал',
'save' => 'Зберегти',
...
'photo' => 'Фото',
'photodescr' => 'Модуль фото галерея',
'name' => 'Назва',
'addnewdevice' => 'Додати новий пристрій до бази ',
