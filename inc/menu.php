...
if($USER){
	...
	$m_device .= '<li class="nav-item"><a class="nav-link" href="/?do=porterror"><div class="i"><i class="fi fi-rr-stats"></i></div><span class="m">'.$lang['porterr'].'</span></a></li>';				
	...
	$m_device .= '<li class="nav-item"><a class="nav-link" href="/?do=statusport"><div class="i"><i class="fi fi-rr-time-twenty-four"></i></div><span class="m">'.$lang['portmon'].'</span></a></li>'; 
	$m_device .= '</li>';
	}
	$m_device .= '</ul></li>';
}
if($config['sklad']=='on' && checkAccess(4)){
	$m_sklad = '<li class="nav-title">'.$lang['tmc'].'</li><li class="nav-item nav-dropdown "><a class="nav-link dropdown-toggle" href="#"><div class="i"><i class="fi fi-rr-copy"></i></div> <span class="m">'.$lang['sklad'].'</span></a>'; 
	$m_sklad .= '<ul class="nav-dropdown-items dropdown">'; 
	$m_sklad .= '<li class="nav-item"><a class="nav-link" href="/?do=add&act=all"><div class="i"><i class="fi fi-rr-apps-add"></i></div><span>'.$lang['addsklad'].'</span></a></li>'; 
	$m_sklad .= '<li class="nav-item"><a class="nav-link" href="/?do=sklad"><div class="i"><i class="fi fi-rr-apps"></i></div><span>'.$lang['listsklad'].'</span></a></li>'; 
	$m_sklad .= '</ul></li>'; 
}
if($USER){
