...
$sel1 .= '<option value="on" '.($config['comment']=='on'?'selected="selected"':'').'>'.($config['comment']=='on'?$lang['ons']:$lang['on']).'</option>';
$sel1 .= '<option value="off" '.($config['comment']=='off'?'selected="selected"':'').'>'.($config['comment']=='off'?$lang['offs']:$lang['off']).'</option>';
...
$sel0 .= '<option value="on" '.($config['errorport']=='on'?'selected="selected"':'').'>'.($config['errorport']=='on'?$lang['ons']:$lang['on']).'</option>';
$sel0 .= '<option value="off" '.($config['errorport']=='off'?'selected="selected"':'').'>'.($config['errorport']=='off'?$lang['offs']:$lang['off']).'</option>';
...
$sel10 .= '<option value="on" '.($config['statusport']=='on'?'selected="selected"':'').'>'.($config['statusport']=='on'?$lang['ons']:$lang['on']).'</option>';
$sel10 .= '<option value="off" '.($config['statusport']=='off'?'selected="selected"':'').'>'.($config['statusport']=='off'?$lang['offs']:$lang['off']).'</option>';
...
$sel2 .= '<option value="on" '.($config['tag']=='on'?'selected="selected"':'').'>'.($config['tag']=='on'?$lang['ons']:$lang['on']).'</option>';
$sel2 .= '<option value="off" '.($config['tag']=='off'?'selected="selected"':'').'>'.($config['tag']=='off'?$lang['offs']:$lang['off']).'</option>';
$setup .= formpage(['img'=>'m11.png','name'=>'Tag','descr'=>$lang['marker_cfg'],'pole'=>'<select class="select" name="tag">'.$sel2.'</select>']);
$sel3 .= '<option value="on" '.($config['pon']=='on'?'selected="selected"':'').'>'.($config['pon']=='on'?$lang['ons']:$lang['on']).'</option>';
$sel3 .= '<option value="off" '.($config['pon']=='off'?'selected="selected"':'').'>'.($config['pon']=='off'?$lang['offs']:$lang['off']).'</option>';
$setup .= formpage(['img'=>'technology.png','name'=>'Pon','descr'=>$lang['cfg_pon_descr'],'pole'=>'<select class="select" name="pon">'.$sel3.'</select>']);
$selrx .= '<option value="on" '.($config['onugraph']=='on'?'selected="selected"':'').'>'.($config['onugraph']=='on'?$lang['ons']:$lang['on']).'</option>';
$selrx .= '<option value="off" '.($config['onugraph']=='off'?'selected="selected"':'').'>'.($config['onugraph']=='off'?$lang['offs']:$lang['off']).'</option>';
...
$sel4 .= '<option value="on" '.($config['sklad']=='on'?'selected="selected"':'').'>'.($config['sklad']=='on'?$lang['ons']:$lang['on']).'</option>';
$sel4 .= '<option value="off" '.($config['sklad']=='off'?'selected="selected"':'').'>'.($config['sklad']=='off'?$lang['offs']:$lang['off']).'</option>';
...
$sel5 .= '<option value="on" '.($config['configport']=='on'?'selected="selected"':'').'>'.($config['configport']=='on'?$lang['ons']:$lang['on']).'</option>';
$sel5 .= '<option value="off" '.($config['configport']=='off'?'selected="selected"':'').'>'.($config['configport']=='off'?$lang['offs']:$lang['off']).'</option>';
...
$sel6 .= '<option value="on" '.($config['unit']=='on'?'selected="selected"':'').'>'.($config['unit']=='on'?$lang['ons']:$lang['on']).'</option>';
$sel6 .= '<option value="off" '.($config['unit']=='off'?'selected="selected"':'').'>'.($config['unit']=='off'?$lang['offs']:$lang['off']).'</option>';
...
$sel7 .= '<option value="on" '.($config['telegram']=='on'?'selected="selected"':'').'>'.($config['telegram']=='on'?$lang['ons']:$lang['on']).'</option>';
$sel7 .= '<option value="off" '.($config['telegram']=='off'?'selected="selected"':'').'>'.($config['telegram']=='off'?$lang['offs']:$lang['off']).'</option>';
...
$sel8 .= '<option value="on" '.($config['marker']=='on'?'selected="selected"':'').'>'.($config['marker']=='on'?$lang['ons']:$lang['on']).'</option>';
$sel8 .= '<option value="off" '.($config['marker']=='off'?'selected="selected"':'').'>'.($config['marker']=='off'?$lang['offs']:$lang['off']).'</option>';
$setup .= formpage(['img'=>'tag.png','name'=>'Marker','descr'=>$lang['marker_cfg'],'pole'=>'<select class="select" name="marker">'.$sel8.'</select>']);
$sel9 .= '<option value="on" '.($config['map']=='on'?'selected="selected"':'').'>'.($config['map']=='on'?$lang['ons']:$lang['on']).'</option>';
$sel9 .= '<option value="off" '.($config['map']=='off'?'selected="selected"':'').'>'.($config['map']=='off'?$lang['offs']:$lang['off']).'</option>';
